...
public class Methods {
    ...
    public static Model selectPerson(int id){
        return mapper.selectPeople(id);
    }

    public static void insertPeople(Model person){
        person.setPersonId(mapper.insertPeople(person));
    }
    ...
    public static void updatePeople(int id, Model person){
